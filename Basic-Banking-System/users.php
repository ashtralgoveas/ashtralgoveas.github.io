...
<body>
    ...
    <class class="welcome">
    <h2><img src="logos/money.png" alt="Bank" width="150" height="80"><strong>Money Transfer</strong></h2>
    </class>
        <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        <a href="history.php"><button type="button" class="btn btn-dark btn-lg mb-3 bg-danger" style="border-radius:30px">See All Transaction History</button></a>
    </div>

 <!-- Table -->
 <div class="container">
        <h2 class="text-center pt-4" style="color : #dc3545;">Customer Details</h2>
            <?php
                include 'connect.php';
                $sid=$_GET['id'];
        ...
        <div>
            <table class="table table-striped table-hover">
                <tr style="color : black;" class="table-danger">
        ...
        <h2 class="text-center pt-4" style="color : #dc3545;">Fill the details to Transfer Money</h2>
        <label style="color : #dc3545; padding-bottom:30px"><strong>Transfer To:</strong></label>
        ...
        <br>
        <br>
            <label style="color : #dc3545;"><strong>Amount:</strong></label>
            <input type="number" class="form-control" name="amount" required>   
            <br><br>
                <div class="text-center" >
                <button class="btn btn-outline-danger mb-4" style="border-radius:30px;" name="submit" type="submit" id="myBtn" >Fill the Amount and Transfer</button>
            </div>
        </form>
    </div>
